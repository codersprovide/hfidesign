...
<span aria-hidden="true">&times;</span></button>
    ...
    <div class="tab-content tab-content-default">
        ...
        <div role="tabpanel" class="tab-pane" id="email_settings">
            ...
            <?php echo Form::open(array('url' => 'admin/email_settings','class'=>'form-horizontal padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')); ?>


                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Host</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_host" value="<?php echo e(env('MAIL_HOST')); ?>" class="form-control" placeholder="mail.example.com">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Port</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_port" value="<?php echo e(env('MAIL_PORT')); ?>" class="form-control"  placeholder="587">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Email</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_email" value="<?php echo e(env('MAIL_USERNAME')); ?>" class="form-control"  placeholder="info@example.com">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Password</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_password" value="<?php echo e(env('MAIL_PASSWORD')); ?>" class="form-control"  placeholder="">
                    </div>
                </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\envato\mobility_cms\resources\views/admin/pages/settings.blade.php ENDPATH**/ ?>