                        ...
                        <div class="media">
                            <div class="media-left">
                                <?php if(isset($service->service_icon)): ?>
                                    ...
                                    <img src="<?php echo e(URL::asset('upload/service/'.$service->service_icon)); ?>" width="55" alt="service">
                                <?php endif; ?>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mobility_cms\resources\views/admin/pages/addeditaddservice.blade.php ENDPATH**/ ?>